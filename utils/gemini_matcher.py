...
def is_matching(imgpath1, imgpath2, max_retries=5) -> str:
    ...
    prompt = (
        ...
        "Icons may include ingredients like mushroom, orange shrimp, light brown chicken strip, circle meatball, dark brown sausage, tomato slice, fried diamond, starburst C icon, stylized M icon, cheese wheel icon.\n"
